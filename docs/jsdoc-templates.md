# JSDoc Templates for Vendure Connector

This document provides standardized JSDoc templates to use when documenting services and methods in the Vendure Connector package.
